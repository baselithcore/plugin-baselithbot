...
function base({ size = 16, strokeWidth = 1.75, ...props }: IconProps) {
  return {
    width: size,
    height: size,
    viewBox: '0 0 24 24',
...
export const Icon = {
  ...
  Bug: (p: IconProps) => (
    <svg {...base(p)}>
      ...
      <path d="M12 2v4M9 4l3 2 3-2M3 10h5M16 10h5M3 18h5M16 18h5M3 14h2M19 14h2" />
    </svg>
  ),
  Folder: (p: IconProps) => (
    <svg {...base(p)}>
  ...
  Cloud: (p: IconProps) => (
    <svg {...base(p)}>
      <path d="M17.5 19a4.5 4.5 0 1 0-1.4-8.78A6 6 0 1 0 6 14h11.5z" />
    </svg>
  ),
  Server: (p: IconProps) => (
    <svg {...base(p)}>
  ...
  Hourglass: (p: IconProps) => (
    <svg {...base(p)}>
      <path d="M6 2h12M6 22h12M7 2v6l5 4-5 4v6M17 2v6l-5 4 5 4v6" />
    </svg>
  ),
  Trash: (p: IconProps) => (
    <svg {...base(p)}>
