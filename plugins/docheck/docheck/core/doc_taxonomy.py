...
NODE_TYPES_BY_DOC_TYPE: dict[DocType, tuple[str, ...]] = {
    ...
    DocType.DPIA: (*_BASE_NODE_TYPES, "processing_activity", "risk_assessment", "safeguard", "data_category"),
    DocType.AUDIT_REPORT: (*_BASE_NODE_TYPES, "control", "evidence", "finding_ref", "scope"),
    DocType.MANUAL: (*_BASE_NODE_TYPES, "chapter", "step", "warning"),
    DocType.TECHNICAL_SPEC: (*_BASE_NODE_TYPES, "requirement", "interface", "constraint"),
