      ...
      <div className="relative mx-auto grid min-h-screen max-w-6xl items-center px-4 py-8 lg:grid-cols-[1fr_440px] lg:gap-10">
        <section className="hidden flex-col justify-between gap-10 p-8 lg:flex">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-base font-semibold tracking-tight">{tCommon('appName')}</div>
          ...
          <div>
            ...
            <p className="mt-5 max-w-xl text-sm leading-6 text-text-secondary">{t('subtitle')}</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            />
            <Trait icon={Database} title={t('traits.auditTitle')} text={t('traits.auditText')} />
            <Trait icon={Network} title={t('traits.agentsTitle')} text={t('traits.agentsText')} />
          </div>
        </section>
...
function Trait({ icon: Icon, title, text }: { icon: LucideIcon; title: string; text: string }) {
  return (
