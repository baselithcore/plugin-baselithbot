"""System-level filesystem initialization (directories and basic system files)."""


class SystemFilesInitializer:
    """Handles creation of system directories and basic system files."""

    def __init__(self, username: str, hostname: str, create_dir_func, create_file_func):
        """Initialize system files initializer.
...
""",
    ...
    def create_common_binaries(self) -> None:
