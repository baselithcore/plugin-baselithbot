 ...
 */ const Ba = '183',
  Gg = { ROTATE: 0, DOLLY: 1, PAN: 2 },
  Hg = { ROTATE: 0, PAN: 1, DOLLY_PAN: 2, DOLLY_ROTATE: 3 },
  bc = 0,
  ho = 1,
  Tc = 2,
  kg = 0,
  ...
  Ze = 2e3,
  qi = 2001,
  p0 = { COMPUTE: 'compute', RENDER: 'render' },
  m0 = { TEXTURE_COMPARE: 'depthTextureCompare' };
function nh(i) {
...
const rh = { [kr]: Wr, [Xr]: Zr, [qr]: Jr, [Si]: Yr, [Wr]: kr, [Zr]: Xr, [Jr]: qr, [Yr]: Si };
class jn {
...
class ht {
  constructor(t = 0, e = 0) {
    ((ht.prototype.isVector2 = !0), (this.x = t), (this.y = e));
  }
  get width() {
    return this.x;
  }
...
class de extends jn {
  ...
  getWorldQuaternion(t) {
    return (this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Pi, t, Lh), t);
  }
  getWorldScale(t) {
    return (this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Pi, Dh, t), t);
  }
  getWorldDirection(t) {
    this.updateWorldMatrix(!0, !1);
...
class Me extends jn {
  ...
  setIndex(t) {
    return (Array.isArray(t) ? (this.index = new (nh(t) ? Gl : Vl)(t, 1)) : (this.index = t), this);
  }
  setIndirect(t, e = 0) {
        ...
        for (let n = 0, s = e.length; n < s; n++) {
          ...
          (Ne.setFromBufferAttribute(r),
            this.morphTargetsRelative
              ? (ve.addVectors(this.boundingBox.min, Ne.min),
                this.boundingBox.expandByPoint(ve),
                ve.addVectors(this.boundingBox.max, Ne.max),
                this.boundingBox.expandByPoint(ve))
  ...
  computeBoundingSphere() {
    ...
    if (t) {
      ...
      if ((Ne.setFromBufferAttribute(t), e))
        for (let r = 0, a = e.length; r < a; r++) {
          ...
          (Ii.setFromBufferAttribute(o),
            this.morphTargetsRelative
              ? (ve.addVectors(Ne.min, Ii.min),
                Ne.expandByPoint(ve),
                ve.addVectors(Ne.max, Ii.max),
                Ne.expandByPoint(ve))
      ...
      for (let r = 0, a = t.count; r < a; r++)
        (ve.fromBufferAttribute(t, r), (s = Math.max(s, n.distanceToSquared(ve))));
      if (e)
        for (let r = 0, a = e.length; r < a; r++) {
          const o = e[r],
            l = this.morphTargetsRelative;
          for (let c = 0, h = o.count; c < h; c++)
            (ve.fromBufferAttribute(o, c),
              l && (fi.fromBufferAttribute(t, c), ve.add(fi)),
              (s = Math.max(s, n.distanceToSquared(ve))));
        }
  ...
  normalizeNormals() {
    ...
    for (let e = 0, n = t.count; e < n; e++)
      (ve.fromBufferAttribute(t, e), ve.normalize(), t.setXYZ(e, ve.x, ve.y, ve.z));
  }
  toNonIndexed() {
    function t(o, l) {
      const c = o.array,
...
function Ss(i, t, e, n, s, r, a, o, l, c) {
  ...
  const h = Gh(i, t, e, n, gs, _s, xs, Do);
  if (h) {
    const f = new L();
    (qe.getBarycoord(Do, gs, _s, xs, f),
      s && (h.uv = qe.getInterpolatedAttribute(s, o, l, c, f, new ht())),
      r && (h.uv1 = qe.getInterpolatedAttribute(r, o, l, c, f, new ht())),
      a &&
...
class kn {
  ...
  setFromCoplanarPoints(t, e, n) {
    const s = wr.subVectors(n, e).cross(kh.subVectors(t, e)).normalize();
...
class Ks {
  ...
  intersectsSprite(t) {
    Vn.center.set(0, 0, 0);
    const e = Xh.distanceTo(t.center);
    return (
      ...
      for (let mt = 0; mt < x; mt++)
        for (let _t = 0; _t < P; _t++) {
          const gt = u + _t + F * mt,
            ...
            jt = u + (_t + 1) + F * (mt + 1),
            ee = u + (_t + 1) + F * mt;
          (l.push(gt, Ot, ee), l.push(Ot, jt, ee), (nt += 6));
        }
...
function ki(i, t, e, n, s) {
  return tu(i, t) + eu(i, e) + nu(i, n) + iu(i, s);
}
class $l extends ln {
  constructor(t = new ht(), e = new ht(), n = new ht(), s = new ht()) {
    (super(),
...
class tc extends ln {
  ...
  fromJSON(t) {
    ...
    for (let e = 0, n = t.points.length; e < n; e++) {
      const s = t.points[e];
      this.points.push(new ht().fromArray(s));
    }
    return this;
  }
}
...
class Da extends au {
  ...
  lineTo(t, e) {
    const n = new Kl(this.currentPoint.clone(), new ht(t, e));
    return (this.curves.push(n), this.currentPoint.set(t, e), this);
  }
  quadraticCurveTo(t, e, n, s) {
    const r = new jl(this.currentPoint.clone(), new ht(t, e), new ht(n, s));
    return (this.curves.push(r), this.currentPoint.set(n, s), this);
  }
  bezierCurveTo(t, e, n, s, r, a) {
    const o = new $l(this.currentPoint.clone(), new ht(t, e), new ht(n, s), new ht(r, a));
...
function ou(i, t, e = 2) {
  ...
  let o, l, c;
  if ((n && (r = fu(i, t, r, e)), i.length > 80 * e)) {
    ((o = i[0]), (l = i[1]));
    let h = o,
      f = l;
    for (let u = e; u < s; u += e) {
...
function fu(i, t, e, n) {
  ...
  for (let r = 0, a = t.length; r < a; r++) {
    const o = t[r] * n,
      ...
      c = ec(i, o, l, n, !1);
    (c === c.next && (c.steiner = !0), s.push(vu(c)));
  }
  s.sort(du);
  for (let r = 0; r < s.length; r++) e = pu(s[r], e);
  return e;
}
function du(i, t) {
  let e = i.x - t.x;
...
function mu(i, t) {
  ...
  do {
    if (
      ...
      $i(e, i) &&
        (f < h || (f === h && (e.x > a.x || (e.x === a.x && gu(a, e))))) &&
        ((a = e), (h = f));
    }
    e = e.next;
  } while (e !== o);
...
function _u(i, t, e, n) {
  ...
  do
    (s.z === 0 && (s.z = Ia(s.x, s.y, t, e, n)),
      ...
      (s = s.next));
  while (s !== i);
  ((s.prevZ.nextZ = null), (s.prevZ = null), xu(s));
}
function xu(i) {
  let t,
    e = 1;
...
function Mu(i, t) {
  return (
    ...
    i.prev.i !== t.i &&
    !Su(i, t) &&
    (($i(i, t) && $i(t, i) && yu(i, t) && (ce(i.prev, i, t.prev) || ce(i, t.prev, t))) ||
...
class rc extends Me {
  constructor(
    t = new Vs([new ht(0.5, 0.5), new ht(-0.5, 0.5), new ht(-0.5, -0.5), new ht(0.5, -0.5)]),
    e = {}
  ) {
    (super(),
    ...
    function a(o) {
      ...
      const d = e.extrudePath,
        E = e.UVGenerator !== void 0 ? e.UVGenerator : Tu;
      let y,
        S = !1,
        R,
        w,
      ...
      for (let $ = 1; $ <= h; $++)
        for (let tt = 0; tt < B; tt++) {
          const K = u ? O(H[tt], gt[tt], ee) : H[tt];
          S
      ...
      function Vt($, tt, K, ut) {
        (ne($), ne(tt), ne(ut), ne(tt), ne(K), ne(ut));
        const A = s.length / 3,
...
const Tu = {
  generateTopUV: function (i, t, e, n, s) {
    const r = t[e * 3],
      ...
      c = t[s * 3],
      h = t[s * 3 + 1];
    return [new ht(r, a), new ht(o, l), new ht(c, h)];
  },
  generateSideWallUV: function (i, t, e, n, s, r) {
    ...
    return Math.abs(o - h) < Math.abs(a - c)
      ? [new ht(a, 1 - l), new ht(c, 1 - f), new ht(u, 1 - g), new ht(M, 1 - d)]
      : [new ht(o, 1 - l), new ht(h, 1 - f), new ht(p, 1 - g), new ht(m, 1 - d)];
  },
};
function Au(i, t, e) {
...
class js extends Me {
  constructor(t = 1, e = 1, n = 1, s = 1) {
    ...
    (this.setIndex(p),
      this.setAttribute('position', new le(g, 3)),
      this.setAttribute('normal', new le(M, 3)),
...
class T0 extends Me {
  constructor(t = null) {
    if (
      ...
      this.setAttribute('position', new le(e, 3));
    }
  }
  copy(t) {
    return (super.copy(t), (this.parameters = Object.assign({}, t.parameters)), this);
...
class on extends Le {
  ...
  copy(t) {
    return (
      ...
      (this.uniformsGroups = wu(t.uniformsGroups)),
...
class k0 {
  ...
  connect(t) {
    ((this._document = t),
      t.hidden !== void 0 &&
        ((this._pageVisibilityHandler = Wu.bind(this)),
...
#endif`,
  af = `vec3 transformed = vec3( position );
#ifdef USE_ALPHAHASH
	vPosition = vec3( position );
#endif`,
  of = `vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
	vec3 objectTangent = vec3( tangent.xyz );
#endif`,
  lf = `float G_BlinnPhong_Implicit( ) {
	return 0.25;
}
...
#endif`,
  mf = `#if defined( USE_COLOR ) || defined( USE_COLOR_ALPHA )
	diffuseColor *= vColor;
#endif`,
  gf = `#if defined( USE_COLOR ) || defined( USE_COLOR_ALPHA )
	varying vec4 vColor;
#endif`,
  _f = `#if defined( USE_COLOR ) || defined( USE_COLOR_ALPHA ) || defined( USE_INSTANCING_COLOR ) || defined( USE_BATCHING_COLOR )
	varying vec4 vColor;
#endif`,
...
#endif`,
  vf = `#define PI 3.141592653589793
...
#endif`,
  Sf = `vec3 transformedNormal = objectNormal;
#ifdef USE_TANGENT
...
transformedNormal = normalMatrix * transformedNormal;
  ...
  wf = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
IncidentLight directLight;
...
#endif`,
  $f = `#if defined( RE_IndirectDiffuse )
	#ifdef USE_LIGHTMAP
...
#endif`,
  jf = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
  ...
  rd = `#if defined( USE_POINTS_UV )
	...
	uniform sampler2D alphaMap;
#endif`,
  ad = `float metalnessFactor = metalness;
...
#endif`,
  dd = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
#endif`,
  vd = `#ifdef USE_CLEARCOAT
	vec3 clearcoatNormal = nonPerturbedNormal;
#endif`,
  Md = `#ifdef USE_CLEARCOAT_NORMALMAP
...
gl_Position = projectionMatrix * mvPosition;`,
  ...
  Dd = `#if NUM_SPOT_LIGHT_COORDS > 0
	...
	#endif
#endif`,
  Id = `#if ( defined( USE_SHADOWMAP ) && ( NUM_DIR_LIGHT_SHADOWS > 0 || NUM_POINT_LIGHT_SHADOWS > 0 ) ) || ( NUM_SPOT_LIGHT_COORDS > 0 )
...
#endif`,
  Zd = `#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || NUM_SPOT_LIGHT_COORDS > 0
...
void main() {
  ...
  qt = {
    ...
    displacementmap_pars_vertex: yf,
...
tn.physical = {
  uniforms: Re([
    tn.standard.uniforms,
    {
      ...
      clearcoatNormalScale: { value: new ht(1, 1) },
      ...
      transmissionSamplerSize: { value: new ht() },
...
function Pp(i, t, e, n, s, r) {
  ...
  function M(E, y) {
    ...
    S && (S.isCubeTexture || S.mapping === Js)
      ? (c === void 0 &&
        ...
        c.material.uniforms.backgroundRotation.value.setFromMatrix4(Cp.makeRotationFromEuler(Gn)),
  ...
  function m(E, y) {
    (E.getRGB(Is, lc(i)), e.buffers.color.setClear(Is.r, Is.g, Is.b, y, r));
  }
  function d() {
      ...
      if (j.location >= 0) {
        ...
        if (
          ...
          const jt = Ot.buffer,
            ...
            rt = ee === i.INT || ee === i.UNSIGNED_INT || mt.gpuType === za;
...
class el {
  ...
  fromScene(t, e = 0, n = 0.1, s = 100, r = {}) {
    const { size: a = 256, position: o = Fp } = r;
  ...
  _allocateTargets() {
    ...
    if (
      ...
      (({ lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas } = Op(r)),
        (this._blurMaterial = zp(r, t, e)),
        (this._ggxMaterial = Bp(r, t, e)));
    }
    return s;
  }
  _compileMaterial(t) {
    const e = new En(new Me(), t);
...
function Xp(i, t, e) {
  ...
  function r(a, o, l) {
    ...
    if (u === void 0 || u.count !== f) {
      ...
      ((u = { count: f, texture: P, size: new ht(S, R) }),
        n.set(o, u),
...
function Zp(i, t, e, n, s) {
  const r = new rn(t, e, { type: i, depthBuffer: n, stencilBuffer: s }),
    a = new rn(t, e, { type: Sn, depthBuffer: !1, stencilBuffer: !1 }),
    o = new Me();
  (o.setAttribute('position', new le([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)),
    o.setAttribute('uv', new le([0, 2, 0, 0, 2, 0], 2)));
  const l = new Lu({
...
function Pm(i, t, e) {
  ...
  let a;
  this.type === i.SAMPLER_2D_SHADOW ? (a = Fa) : (a = dc);
...
function Lm(i, t, e) {
  const n = this.cache,
    ...
    r = tr(e, s);
  ge(n, r) || (i.uniform1iv(this.addr, r), _e(n, r));
  for (let a = 0; a !== s; ++a) e.setTexture3D(t[a] || mc, r[a]);
}
function Dm(i, t, e) {
  const n = this.cache,
    s = t.length,
    r = tr(e, s);
  ge(n, r) || (i.uniform1iv(this.addr, r), _e(n, r));
  for (let a = 0; a !== s; ++a) e.setTextureCube(t[a] || gc, r[a]);
}
function Im(i, t, e) {
  const n = this.cache,
    s = t.length,
    r = tr(e, s);
  ge(n, r) || (i.uniform1iv(this.addr, r), _e(n, r));
  for (let a = 0; a !== s; ++a) e.setTexture2DArray(t[a] || pc, r[a]);
}
function Um(i) {
  switch (i) {
    case 5126:
...
function Bm(i, t, e) {
  ...
  for (zr.lastIndex = 0; ; ) {
    ...
    if ((l && (o = o | 0), c === void 0 || (c === '[' && a + 2 === s))) {
      hl(e, c === void 0 ? new Nm(o, i, t) : new Fm(o, i, t));
      break;
    } else {
      let f = e.map[o];
      (f === void 0 && ((f = new Om(o)), hl(e, f)), (e = f));
    }
  }
}
class Gs {
...
const eg = { [Ns]: 'SHADOWMAP_TYPE_PCF', [Oi]: 'SHADOWMAP_TYPE_VSM' };
function ng(i) {
  return eg[i.shadowMapType] || 'SHADOWMAP_TYPE_BASIC';
}
const ig = { [Jn]: 'ENVMAP_TYPE_CUBE', [yi]: 'ENVMAP_TYPE_CUBE', [Js]: 'ENVMAP_TYPE_CUBE_UV' };
function sg(i) {
  return i.envMap === !1 ? 'ENVMAP_TYPE_CUBE' : ig[i.envMapMode] || 'ENVMAP_TYPE_CUBE';
}
const rg = { [yi]: 'ENVMAP_MODE_REFRACTION' };
function ag(i) {
  return i.envMap === !1 ? 'ENVMAP_MODE_REFLECTION' : rg[i.envMapMode] || 'ENVMAP_MODE_REFLECTION';
}
const og = {
  [Zs]: 'ENVMAP_BLENDING_MULTIPLY',
  [Xc]: 'ENVMAP_BLENDING_MIX',
  [qc]: 'ENVMAP_BLENDING_ADD',
};
function lg(i) {
  return i.envMap === !1 ? 'ENVMAP_BLENDING_NONE' : og[i.combine] || 'ENVMAP_BLENDING_NONE';
}
function cg(i) {
...
`)),
      (d = [
        ...
        e.toneMapping !== nn ? Xm('toneMapping', e.toneMapping) : '',
        e.dithering ? '#define DITHERING' : '',
        e.opaque ? '#define OPAQUE' : '',
        qt.colorspace_pars_fragment,
        km('linearToOutputTexel', e.outputColorSpace),
        qm(),
...
` +
    ...
    (s.deleteShader(R), s.deleteShader(w), (x = new Gs(s, M)), (b = Jm(s, M)));
  }
  let x;
  ...
  return (
    (this.isReady = function () {
      return (H === !1 && (H = s.getProgramParameter(M, zm)), H);
    }),
...
class fg {
  ...
  _getShaderStage(t) {
    ...
    let n = e.get(t);
    return (n === void 0 && ((n = new dg(t)), e.set(t, n)), n);
  }
}
class dg {
  constructor(t) {
    ((this.id = ug++), (this.code = t), (this.usedTimes = 0));
  }
}
function pg(i, t, e, n, s, r) {
  const a = new Ja(),
    o = new fg(),
    l = new Set(),
    c = [],
  ...
  function M(x, b, H, C, N) {
    ...
    const oe = {
      ...
      displacementMap: A,
      emissiveMap: Dt,
      normalMapObjectSpace: ut && x.normalMapType === Jc,
      ...
      thicknessMapUv: ct && g(x.thicknessMap.channel),
  ...
  function y(x) {
    ...
    if (b) {
      const C = tn[b];
      H = Ru.clone(C.uniforms);
    } else H = x.uniforms;
    return H;
  }
  function S(x, b) {
    let H = h.get(b);
    return (H !== void 0 ? ++H.usedTimes : ((H = new hg(i, b, x, s)), c.push(H), h.set(b, H)), H);
  }
  function R(x) {
    if (--x.usedTimes === 0) {
      const b = c.indexOf(x);
    ...
    for (let k = 0, F = w.length; k < F; k++) {
      ...
      if (((B.camera._reversedDepth = j), B.map === null || z === !0)) {
        if (
          ...
          (O.isPointLight
            ? ((B.map = new fc(s.x)), (B.map.depthTexture = new Zh(s.x, an)))
...
function Cg(i, t) {
  function e() {
    ...
    return {
      ...
      setClear: function (et, Y, bt, Gt, oe) {
        (oe === !0 && ((et *= Gt), (Y *= Gt), (bt *= Gt)),
          ct.set(et, Y, bt, Gt),
          St.equals(ct) === !1 && (i.clearColor(et, Y, bt, Gt), St.copy(ct)));
      },
      reset: function () {
  ...
  function n() {
    ...
    return {
      ...
      setClear: function (Y) {
        et !== Y && ((et = Y), ct && (Y = 1 - Y), i.clearDepth(Y));
      },
      reset: function () {
        ((D = !1), (st = null), (St = null), (et = null), (ct = !1));
      },
    };
  }
  function s() {
    ...
    return {
      ...
      setMask: function (Qt) {
        ct !== Qt && !D && (i.stencilMask(Qt), (ct = Qt));
      },
  ...
  function ee(D, ct, st, St) {
    ...
    for (let bt = 0; bt < st; bt++)
      D === i.TEXTURE_3D || D === i.TEXTURE_2D_ARRAY
        ? i.texImage3D(ct, 0, i.RGBA, 1, 1, St, 0, i.RGBA, i.UNSIGNED_BYTE, et)
        : i.texImage2D(ct + bt, 0, i.RGBA, 1, 1, 0, i.RGBA, i.UNSIGNED_BYTE, et);
    return Y;
  }
  const Z = {};
  ((Z[i.TEXTURE_2D] = ee(i.TEXTURE_2D, i.TEXTURE_2D, 1)),
    (Z[i.TEXTURE_CUBE_MAP] = ee(i.TEXTURE_CUBE_MAP, i.TEXTURE_CUBE_MAP_POSITIVE_X, 6)),
    (Z[i.TEXTURE_2D_ARRAY] = ee(i.TEXTURE_2D_ARRAY, i.TEXTURE_2D_ARRAY, 1, 1)),
    (Z[i.TEXTURE_3D] = ee(i.TEXTURE_3D, i.TEXTURE_3D, 1, 1)),
    r.setClear(0, 0, 0, 1),
    a.setClear(1),
    o.setClear(0),
    rt(i.DEPTH_TEST),
  ...
  function It(D, ct) {
    return f[D] !== ct
      ? (i.bindFramebuffer(D, ct),
        (f[D] = ct),
        D === i.DRAW_FRAMEBUFFER && (f[i.FRAMEBUFFER] = ct),
        D === i.FRAMEBUFFER && (f[i.DRAW_FRAMEBUFFER] = ct),
        !0)
      : !1;
  }
  function Lt(D, ct) {
    let st = p,
      St = !1;
    if (D) {
      ((st = u.get(ct)), st === void 0 && ((st = []), u.set(ct, st)));
      const et = D.textures;
  ...
  const ne = { [Wn]: i.FUNC_ADD, [Rc]: i.FUNC_SUBTRACT, [Cc]: i.FUNC_REVERSE_SUBTRACT };
  ((ne[Pc] = i.MIN), (ne[Lc] = i.MAX));
  const Ht = {
    [Dc]: i.ZERO,
    [Ic]: i.ONE,
    [Uc]: i.SRC_COLOR,
    [Gr]: i.SRC_ALPHA,
    [Vc]: i.SRC_ALPHA_SATURATE,
    [Bc]: i.DST_COLOR,
    [Fc]: i.DST_ALPHA,
    [Nc]: i.ONE_MINUS_SRC_COLOR,
    [Hr]: i.ONE_MINUS_SRC_ALPHA,
    [zc]: i.ONE_MINUS_DST_COLOR,
    [Oc]: i.ONE_MINUS_DST_ALPHA,
    [Gc]: i.CONSTANT_COLOR,
    [Hc]: i.ONE_MINUS_CONSTANT_COLOR,
    [kc]: i.CONSTANT_ALPHA,
    [Wc]: i.ONE_MINUS_CONSTANT_ALPHA,
  };
  function $(D, ct, st, St, et, Y, bt, Gt, oe, Qt) {
    if (D === vn) {
      M === !0 && (at(i.BLEND), (M = !1));
      return;
    }
    if ((M === !1 && (rt(i.BLEND), (M = !0)), D !== wc)) {
      if (D !== m || Qt !== b) {
    ...
    ((et = et || ct),
      (Y = Y || st),
      (bt = bt || St),
      (ct !== d || et !== S) && (i.blendEquationSeparate(ne[ct], ne[et]), (d = ct), (S = et)),
      (st !== E || St !== y || Y !== R || bt !== w) &&
        (i.blendFuncSeparate(Ht[st], Ht[St], Ht[Y], Ht[bt]), (E = st), (y = St), (R = Y), (w = bt)),
      (Gt.equals(P) === !1 || oe !== x) &&
        (i.blendColor(Gt.r, Gt.g, Gt.b, oe), P.copy(Gt), (x = oe)),
      (m = D),
      (b = !1));
  }
  function tt(D, ct) {
  ...
  function Dt(D, ct, st) {
    D
      ? (rt(i.POLYGON_OFFSET_FILL),
        (z !== ct || k !== st) &&
          ((z = ct), (k = st), a.getReversed() && (ct = -ct), i.polygonOffset(ct, st)))
  ...
  function ot(D, ct, st) {
    ...
    (St === void 0 && ((St = { type: void 0, texture: void 0 }), (mt[st] = St)),
      (St.type !== D || St.texture !== ct) &&
        (j !== st && (i.activeTexture(st), (j = st)),
        i.bindTexture(D, ct || Z[D]),
        (St.type = D),
        (St.texture = ct)));
  }
  function T() {
  ...
  function Tt(D, ct) {
    let st = c.get(ct);
    st === void 0 && ((st = new WeakMap()), c.set(ct, st));
    let St = st.get(D);
    St === void 0 && ((St = i.getUniformBlockIndex(ct, D.name)), st.set(D, St));
  }
  function vt(D, ct) {
    const St = c.get(ct).get(D);
    l.get(ct) !== St && (i.uniformBlockBinding(ct, St, D.__bindingPointIndex), l.set(ct, St));
  }
  function Yt() {
    (i.disable(i.BLEND),
    ...
    if (q.length === 0) e.texSubImage2D(i.TEXTURE_2D, 0, 0, 0, _.width, _.height, I, X, _.data);
      ...
      for (let Q = 0, it = q.length; Q < it; Q++) {
        ...
        (i.pixelStorei(i.UNPACK_SKIP_PIXELS, Yt),
          ...
          e.texSubImage2D(i.TEXTURE_2D, 0, Yt, D, ct, st, I, X, _.data));
      }
      (T.clearUpdateRanges(),
  ...
  function Z(T, _, I) {
    ...
    if (q.version !== yt.__version || J === !0) {
      ...
      if (_.isDepthTexture)
        ...
        if (Yt.length > 0) {
          D && ct && e.texStorage2D(i.TEXTURE_2D, St, Tt, Yt[0].width, Yt[0].height);
          ...
          D
            ? (ct && e.texStorage2D(i.TEXTURE_2D, St, Tt, Q.width, Q.height),
              st && ee(_, Q, it, Et))
            : e.texImage2D(i.TEXTURE_2D, 0, Tt, Q.width, Q.height, 0, it, Et, Q.data);
      else if (_.isCompressedTexture)
        if (_.isCompressedArrayTexture) {
          D && ct && e.texStorage3D(i.TEXTURE_2D_ARRAY, St, Tt, Yt[0].width, Yt[0].height, Q.depth);
          for (let et = 0, Y = Yt.length; et < Y; et++)
        ...
        if (D) {
          if ((ct && e.texStorage3D(i.TEXTURE_2D_ARRAY, St, Tt, Q.width, Q.height, Q.depth), st))
            if (_.layerUpdates.size > 0) {
        ...
        D
          ? (ct && e.texStorage3D(i.TEXTURE_3D, St, Tt, Q.width, Q.height, Q.depth),
            st &&
  ...
  function rt(T, _, I) {
    ...
    if (J.version !== q.__version || X === !0) {
      ...
      const Et = it[0],
        ...
        D = _.isVideoTexture !== !0,
        ct = q.__version === void 0 || X === !0,
        st = J.dataReady;
      let St = R(_, Et);
      gt(i.TEXTURE_CUBE_MAP, _);
      let et;
      if (Nt) {
        D && ct && e.texStorage2D(i.TEXTURE_CUBE_MAP, St, Yt, Et.width, Et.height);
        for (let Y = 0; Y < 6; Y++) {
          et = it[Y].mipmaps;
...
function Og(i, t) {
  ...
  function n(m, d) {
    (d.color.getRGB(m.fogColor.value, lc(i)),
      d.isFog
  ...
  function r(m, d) {
    ...
    (y &&
      ...
      m.envMapRotation.value.setFromMatrix4(Fg.makeRotationFromEuler(Hn)),
...
class K0 {
  constructor(t = {}) {
    ...
    let xt, Ut, ot, T, _, I, X, J, q, yt, lt, Ct, Nt, Q, it, Et, Tt, vt, Yt, D, ct, st, St;
    function et() {
      ((xt = new Gp(A)),
        xt.init(),
        (ct = new Lg(A, xt)),
        ...
        (T = new Wp(A)),
        (_ = new mg()),
        (I = new Pg(A, xt, ot, _, Ut, ct, T)),
        (X = new Vp(b)),
        (J = new Zu(A)),
        (st = new Lp(A, J)),
        (q = new Hp(A, J, T, st)),
        (yt = new qp(A, q, J, st, T)),
        (vt = new Xp(A, Ut, I)),
        (it = new Up(_)),
        (lt = new pg(b, X, xt, Ut, st, it)),
        (Ct = new Og(b, _)),
        (Nt = new _g()),
        (Q = new Eg(xt)),
        (Tt = new Pp(b, X, ot, yt, g, l)),
        (Et = new Rg(b, yt, Ut)),
        (St = new Bg(A, T, Ut, ot)),
        (Yt = new Dp(A, xt, T)),
        (D = new kp(A, xt, T)),
    ...
    (et(), M !== Oe && (x = new Zp(M, e.width, e.height, s, r)));
    const Y = new Ng(b, A);
    ((this.xr = Y),
    ...
    this.renderBufferDirect = function (v, U, W, G, V, dt) {
      ...
      let Pt = kt.start * Rt,
        ie = (kt.start + kt.count) * Rt;
      (dt !== null &&
        ((Pt = Math.max(Pt, dt.start * Rt)), (ie = Math.min(ie, (dt.start + dt.count) * Rt))),
        At !== null
          ? ((Pt = Math.max(Pt, 0)), (ie = Math.min(ie, At.count)))
          : Zt != null && ((Pt = Math.max(Pt, 0)), (ie = Math.min(ie, Zt.count))));
      const fe = ie - Pt;
      if (fe < 0 || fe === 1 / 0) return;
      st.setup(V, G, pt, W, At);
      let he,
        se = Yt;
      if ((At !== null && ((he = J.get(At)), (se = D), se.setIndex(he)), V.isMesh))
        G.wireframe === !0
          ? (ot.setLineWidth(G.wireframeLinewidth * ut()), se.setMode(A.LINES))
          : se.setMode(A.TRIANGLES);
      else if (V.isLine) {
        let Ee = G.linewidth;
        (Ee === void 0 && (Ee = 1),
          ...
          V.isLineSegments
            ? se.setMode(A.LINES)
            : V.isLineLoop
              ? se.setMode(A.LINE_LOOP)
              : se.setMode(A.LINE_STRIP));
      } else V.isPoints ? se.setMode(A.POINTS) : V.isSprite && se.setMode(A.TRIANGLES);
      if (V.isBatchedMesh)
        if (V._multiDrawInstances !== null)
          (Ws(
            'WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection.'
          ),
            se.renderMultiDrawInstances(
              V._multiDrawStarts,
              V._multiDrawCounts,
              V._multiDrawCount,
          ...
          se.renderMultiDraw(V._multiDrawStarts, V._multiDrawCounts, V._multiDrawCount);
        else {
          ...
          for (let Je = 0; Je < De; Je++)
            (He.setValue(A, '_gl_DrawID', Je), se.render(Ee[Je] / Kt, wt[Je]));
        }
      else if (V.isInstancedMesh) se.renderInstances(Pt, fe, V.count);
        ...
        se.renderInstances(Pt, fe, wt);
      } else se.render(Pt, fe);
    };
    function eo(v, U, W) {
    ...
    (Nn.setAnimationLoop(_c),
      ...
      (this.render = function (v, U) {
        ...
        if (
          ...
          It.setFromProjectionMatrix(ne, Ze, U.reversedDepth),
      ...
      if (v.layers.test(U.layers)) {
        if (v.isGroup) W = v.renderOrder;
          ...
          if (!v.frustumCulled || It.intersectsSprite(v)) {
            G && $.setFromMatrixPosition(v.matrixWorld).applyMatrix4(ne);
          ...
          if (
            (G &&
              ...
              $.applyMatrix4(v.matrixWorld).applyMatrix4(ne)),
            Array.isArray(pt))
          ) {
            const At = Mt.groups;
            for (let Rt = 0, kt = At.length; Rt < kt; Rt++) {
    ...
    function ro(v, U, W, G) {
      ...
      if (
        ...
        let Pt = !1;
        for (let ie = 0, fe = U.length; ie < fe; ie++) {
          const he = U[ie],
            { object: se, geometry: Ee, material: wt, group: De } = he;
          if (wt.side === gn && se.layers.test(G.layers)) {
            const Kt = wt.side;
            ((wt.side = Pe),
              (wt.needsUpdate = !0),
              ao(se, W, G, Ee, wt, De),
    ...
    function xc(v, U, W, G, V) {
      ...
      const dt = U.fog,
        ...
        ie = !!W.morphAttributes.normal,
        fe = !!W.morphAttributes.color;
      let he = nn;
      G.toneMapped && (z === null || z.isXRRenderTarget === !0) && (he = b.toneMapping);
      const se = W.morphAttributes.position || W.morphAttributes.normal || W.morphAttributes.color,
      ...
      if (
        ...
        (ot.buffers.depth.getReversed() &&
          ...
          re.setValue(A, 'projectionMatrix', v.projectionMatrix),
          re.setValue(A, 'viewMatrix', v.matrixWorldInverse));
        const Tn = re.map.cameraPosition;
        (Tn !== void 0 && Tn.setValue(A, Ht.setFromMatrixPosition(v.matrixWorld)),
          Ut.logarithmicDepthBuffer &&
            re.setValue(A, 'logDepthBufFC', 2 / (Math.log(v.far + 1) / Math.LN2)),
          (G.isMeshPhongMaterial ||
            ...
            G.isMeshStandardMaterial ||
            G.isShaderMaterial) &&
            re.setValue(A, 'isOrthographic', v.isOrthographicCamera === !0),
          F !== v && ((F = v), (Fn = !0), (ti = !0)));
      }
      if (
        (wt.needsLights &&
          (De.state.directionalShadowMap.length > 0 &&
            re.setValue(A, 'directionalShadowMap', De.state.directionalShadowMap, I),
          De.state.spotShadowMap.length > 0 &&
            re.setValue(A, 'spotShadowMap', De.state.spotShadowMap, I),
          De.state.pointShadowMap.length > 0 &&
            re.setValue(A, 'pointShadowMap', De.state.pointShadowMap, I)),
        V.isSkinnedMesh)
      ) {
        (re.setOptional(A, V, 'bindMatrix'), re.setOptional(A, V, 'bindMatrixInverse'));
        const xe = V.skeleton;
        xe &&
          (xe.boneTexture === null && xe.computeBoneTexture(),
          re.setValue(A, 'boneTexture', xe.boneTexture, I));
      }
      V.isBatchedMesh &&
        (re.setOptional(A, V, 'batchingTexture'),
        re.setValue(A, 'batchingTexture', V._matricesTexture, I),
        re.setOptional(A, V, 'batchingIdTexture'),
        re.setValue(A, 'batchingIdTexture', V._indirectTexture, I),
        re.setOptional(A, V, 'batchingColorTexture'),
        V._colorsTexture !== null && re.setValue(A, 'batchingColorTexture', V._colorsTexture, I));
      const bn = W.morphAttributes;
      if (
        ((bn.position !== void 0 || bn.normal !== void 0 || bn.color !== void 0) &&
          vt.update(V, W, He),
        (Fn || wt.receiveShadow !== V.receiveShadow) &&
          ((wt.receiveShadow = V.receiveShadow), re.setValue(A, 'receiveShadow', V.receiveShadow)),
        (G.isMeshStandardMaterial || G.isMeshLambertMaterial || G.isMeshPhongMaterial) &&
          G.envMap === null &&
          U.environment !== null &&
          (Se.envMapIntensity.value = U.environmentIntensity),
        Se.dfgLUT !== void 0 && (Se.dfgLUT.value = Vg()),
        Fn &&
          (re.setValue(A, 'toneMappingExposure', b.toneMappingExposure),
          wt.needsLights && vc(Se, ti),
        ...
        G.isSpriteMaterial && re.setValue(A, 'center', V.center),
        re.setValue(A, 'modelViewMatrix', V.modelViewMatrix),
        re.setValue(A, 'normalMatrix', V.normalMatrix),
        re.setValue(A, 'modelMatrix', V.matrixWorld),
        G.isShaderMaterial || G.isRawShaderMaterial)
      ) {
        const xe = G.uniformsGroups;
        for (let Tn = 0, ei = xe.length; Tn < ei; Tn++) {
          const co = xe[Tn];
        ...
        if ((v.isWebGLCubeRenderTarget && Mt !== void 0 && (At = At[Mt]), At)) {
          ...
          try {
            ...
            U >= 0 &&
              ...
              W >= 0 &&
              W <= v.height - V &&
              A.readPixels(U, W, G, V, ct.convert(kt), ct.convert(Zt), dt);
          } finally {
        ...
        if ((v.isWebGLCubeRenderTarget && Mt !== void 0 && (At = At[Mt]), At))
          if (U >= 0 && U <= v.width - G && W >= 0 && W <= v.height - V) {
            ...
            (A.bindBuffer(A.PIXEL_PACK_BUFFER, Pt),
              ...
              A.readPixels(U, W, G, V, ct.convert(kt), ct.convert(Zt), 0));
            const ie = z !== null ? _.get(z).__webglFramebuffer : null;
            ot.bindFramebuffer(A.FRAMEBUFFER, ie);
    ...
    ((this.copyTextureToTexture = function (v, U, W = null, G = null, V = 0, dt = 0) {
      ...
      G !== null ? ((Pt = G.x), (ie = G.y), (fe = G.z)) : ((Pt = 0), (ie = 0), (fe = 0));
      const se = ct.convert(U.format),
        Ee = ct.convert(U.type);
      let wt;
      (U.isData3DTexture
      ...
      const ti = v.isDataArrayTexture || v.isData3DTexture,
        re = U.isDataArrayTexture || U.isData3DTexture;
      if (v.isDepthTexture) {
        const Se = _.get(v),
          bn = _.get(U),
          xe = _.get(Se.__renderTarget),
          Tn = _.get(bn.__renderTarget);
        (ot.bindFramebuffer(A.READ_FRAMEBUFFER, xe.__webglFramebuffer),
        ...
        for (let ei = 0; ei < At; ei++)
          (ti &&
            ...
            A.blitFramebuffer(Rt, kt, Mt, pt, Pt, ie, Mt, pt, A.DEPTH_BUFFER_BIT, A.NEAREST));
        ...
        const Se = _.get(v),
          bn = _.get(U);
        (ot.bindFramebuffer(A.READ_FRAMEBUFFER, yc), ot.bindFramebuffer(A.DRAW_FRAMEBUFFER, Ec));
        for (let xe = 0; xe < At; xe++)
          (ti
            ? A.framebufferTextureLayer(
                A.READ_FRAMEBUFFER,
                A.COLOR_ATTACHMENT0,
            ...
            V !== 0
              ? A.blitFramebuffer(Rt, kt, Mt, pt, Pt, ie, Mt, pt, A.COLOR_BUFFER_BIT, A.NEAREST)
              : re
                ? A.copyTexSubImage3D(wt, dt, Pt, ie, fe + xe, Rt, kt, Mt, pt)
                : A.copyTexSubImage2D(wt, dt, Pt, ie, Rt, kt, Mt, pt));
        (ot.bindFramebuffer(A.READ_FRAMEBUFFER, null),
          ot.bindFramebuffer(A.DRAW_FRAMEBUFFER, null));
      } else
        re
          ? v.isDataTexture || v.isData3DTexture
            ? A.texSubImage3D(wt, dt, Pt, ie, fe, Mt, pt, At, se, Ee, he.data)
            : U.isCompressedArrayTexture
              ? A.compressedTexSubImage3D(wt, dt, Pt, ie, fe, Mt, pt, At, se, he.data)
              : A.texSubImage3D(wt, dt, Pt, ie, fe, Mt, pt, At, se, Ee, he)
          : v.isDataTexture
            ? A.texSubImage2D(A.TEXTURE_2D, dt, Pt, ie, Mt, pt, se, Ee, he.data)
            : v.isCompressedTexture
              ...
              : A.texSubImage2D(A.TEXTURE_2D, dt, Pt, ie, Mt, pt, se, Ee, he);
