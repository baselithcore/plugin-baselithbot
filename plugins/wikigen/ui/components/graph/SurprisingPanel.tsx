  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-ink-muted">
        Archi ad alta confidence che attraversano community diverse — di solito i collegamenti più
        informativi del grafo.
      </p>
      {items.length === 0 ? (
        <div className="rounded-md bg-canvas px-3 py-2 text-xs text-ink-muted">
          ...
          <code className="mx-1 rounded bg-canvas-raised px-1">GRAPH_CONFIDENCE_MIN</code>o ad
          estrarre più pagine.
        </div>
      ) : (
