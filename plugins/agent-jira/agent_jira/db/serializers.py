...
def deserialize_sources(
    raw_sources: Optional[Any],
) -> List[Dict[str, Any]]:
    """Converte le fonti (JSON string o lista già deserializzata da jsonb) in strutture Python."""

    if not raw_sources:
        return []

    # Se è già una lista (proveniente da colonna jsonb), usala direttamente
