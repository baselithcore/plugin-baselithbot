...
try:  # pragma: no cover - fallback se la dipendenza non è installata
...
class TelemetryCollector:
    """Raccoglie metriche contatore thread-safe per l'agente e il backend."""
    ...
    def __init__(self) -> None:
        ...
        self._prom_counter = (
            PrometheusCounter(
                "chatbot_events_total",
                "Conteggio degli eventi di telemetria del chatbot.",
                ["name"],
            )
