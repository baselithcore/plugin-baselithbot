...
network retry of a metric-ingest POST can't double-count. Bounded LRU; in-memory
and per-process (a multi-replica deployment would back this with a shared store).
"""
