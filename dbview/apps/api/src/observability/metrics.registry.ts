...
export const httpRequestErrors = new Counter({
  ...
  labelNames: ['method', 'route', 'status_bucket', 'reason'] as const,
  registers: [registry],
});
...
export const llmCalls = new Counter({
  ...
  labelNames: ['provider', 'model', 'mode', 'status'] as const,
  registers: [registry],
});
...
export const queryExecutions = new Counter({
  ...
  labelNames: ['dialect', 'status'] as const,
  registers: [registry],
});
...
export const introspectionFailures = new Counter({
  ...
  labelNames: ['dialect', 'reason'] as const,
  registers: [registry],
});
...
export const connectionsUp = new Gauge({
  ...
  labelNames: ['connection_id', 'dialect'] as const,
  registers: [registry],
});
