import { isDocumentDialect, isGraphDialect, isKeyValueDialect, isSaasDialect, isSearchDialect, isSqlDialect, isVectorDialect, parseSalesforceConnection, } from '@dbview/shared';
import { createExecutor as createSqlExecutor, createIntrospector as createSqlIntrospector, } from '@dbview/sql-core';
import { FalkorExecutor, FalkorIntrospector, Neo4jExecutor, Neo4jIntrospector, UltipaExecutor, UltipaIntrospector, } from '@dbview/cypher-core';
...
import { SalesforceClient, SalesforceExecutor, SalesforceIntrospector, } from './salesforce/index.js';
import { SalesforceDataCloudClient, SalesforceDataCloudExecutor, SalesforceDataCloudIntrospector, } from './salesforce-data-cloud/index.js';
export function createQueryEngine(dialect, connectionString) {
