    ...
    load() {
        ...
        try {
            ...
            if (!Array.isArray(data.connections))
                return;
            const fileVersion = data.version === 2 ? 2 : data.version === 1 ? 1 : CURRENT_SCHEMA_VERSION;
            this.loadedVersion = fileVersion;
            for (const c of data.connections) {
                const isLegacy = !c.ownerId;
                if (isLegacy)
                    this.legacyIds.add(c.id);
...
//# sourceMappingURL=connections.store.js.map