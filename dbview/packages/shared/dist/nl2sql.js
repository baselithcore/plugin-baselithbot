...
export function isRemoteLlmProvider(p) {
...
export function isIncompatibleOllamaModel(name) {
...
export function isSqlcoderModel(name) {
 ...
 */
const CODING_OLLAMA_MODELS = /(^|[-_/:])(sqlcoder|codellama|deepseek-?coder|codegemma|starcoder|codestral|granite-?code|phind-codellama|qwen[\d.]*-?coder|magicoder|wizardcoder|opencodeinterpreter|coder|code-)/i;
export function isCodingOllamaModel(name) {
    if (isIncompatibleOllamaModel(name))
        return false;
