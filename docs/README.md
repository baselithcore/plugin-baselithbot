...
pairing, a remote gateway, a cost/usage ledger, a React dashboard, and
an extensive MCP tool surface — all composable from one plugin mount
point (`/baselithbot`).
...
| 3 | [configuration.md](./configuration.md) | `plugins.yaml` keys, `StealthConfig`, `ComputerUseConfig`, env vars |
| 4 | [http-api.md](./http-api.md) | Core routes, WebSocket pairing, inbound webhooks, static UI |
| 5 | [dashboard.md](./dashboard.md) | React SPA pages, dashboard REST+SSE API |
| 6 | [mcp-tools.md](./mcp-tools.md) | 36 MCP tools — browser, Computer Use, OpenClaw, extras |
| 7 | [subsystems.md](./subsystems.md) | Channels, sessions, skills, cron, nodes, gateway, voice, canvas |
| 8 | [computer-use.md](./computer-use.md) | OS-level safety model, capability gates, audit |
| 9 | [models.md](./models.md) | LLM/Vision prefs, failover chain, persistence |
| 10 | [security.md](./security.md) | Auth, rate limits, inbound hardening, security headers |
| 11 | [observability.md](./observability.md) | Prometheus, audit log, structured logs, SSE bus |
| 12 | [cli-sdk.md](./cli-sdk.md) | CLI reference, Python SDK usage, orchestrator intents |
| 13 | [operations.md](./operations.md) | Testing, deployment recipes, troubleshooting, roadmap |
